...
const myEvents: any[] = []; // Empty array - will be populated from user data
    ...
    <div className="space-y-6">
      ...
      {myEvents.length === 0 ? (
        <div className="text-center py-12">
          ...
          <div className="mt-6">
            <Link href="/events" className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
              Browse Events
            </Link>
          </div>
        </div>
